      ...
      <AuthProvider>
        <Routes>
          ...
          <Route
            ...
            element={<LoginPage />}
          />
          {/* Project Initiator Dashboard */}
          <Route
            path="/dashboard/initiator"
            element={<ProjectInitiatorDashboard currentRole="project_initiator" />}
          />
          {/* Contractor Dashboard */}
          <Route
            path="/dashboard/contractor"
            element={<ContractorDashboard currentRole="contractor" />}
          />
          {/* Webadmin Dashboard */}
          <Route
            path="/dashboard/webadmin"
            element={<WebadminDashboard currentRole="webadmin" />}
          />
          {/* Regional Manager Dashboard */}
          <Route
            path="/dashboard/regional"
            element={<RegionalManagerDashboard currentRole="regional_manager" />}
          />
          {/* Global Design House Supply Pool */}
          <Route
            path="/supply-pool"
            element={<SupplyPoolPage />}
          />
          {/* Project Management */}
          <Route
          ...
          <Route
            path="/payments"
            element={<PaymentSettlementPage />}
          />
          {/* AI Assistant Panel (standalone) */}
          <Route
            path="/ai-assistant"
            element={<AIAssistantPanel currentRole="project_initiator" />}
          />
          {/* Redirects for demo */}
