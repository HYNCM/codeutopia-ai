...
import { mockProjects, categoryLabels, statusLabels, PROJECT_CATEGORIES, SKILLS } from '../data/mockData';
      ...
      <div className="flex flex-col lg:flex-row lg:items-start gap-4">
        ...
        <div className="lg:w-64 flex flex-col gap-3">
          ...
          <div className="space-y-2">
            <Link
              to={`/projects/${project.id}`}
              className="block w-full py-2.5 bg-gradient-to-r from-purple-600 to-blue-600 text-white text-center rounded-lg font-medium hover:from-purple-700 hover:to-blue-700 transition-all"
            >
              查看詳情
            </Link>
