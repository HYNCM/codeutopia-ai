      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
        ...
        <div className='lg:col-span-2 bg-white rounded-xl border border-gray-200 p-6'>
          <div className='flex items-center justify-between mb-6'>
            ...
            <Link to='/projects' className='flex items-center space-x-1 text-sm text-purple-600 hover:text-purple-700'>
              <span>查看全部</span>
              ...
              <Link
                ...
                <div className='flex items-start justify-between mb-3'>
                  <div>
                    ...
                    <p className='text-sm text-gray-500 mt-1'>{categoryLabels[project.category]}</p>
                  </div>
                ...
                <div className='flex items-center justify-between'>
                  ...
                  <span className='text-sm text-purple-600 font-medium'>{project.bids.length} 個投標</span>
                </div>
        ...
        <div className='space-y-6'>
            ...
            <div className='space-y-4'>
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-xs text-gray-500 mt-0.5'>AI分析顯示您的項目平均提前2天完成</p>
                </div>
              </div>
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-xs text-gray-500 mt-0.5'>有3位符合您項目需求的優質開發者</p>
                </div>
              </div>
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-xs text-gray-500 mt-0.5'>使用AI代碼審查可節省約15%測試成本</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className='bg-white rounded-xl border border-gray-200 p-6'>
            <div className='flex items-center justify-between mb-4'>
              ...
              <Link to='/transactions' className='text-sm text-purple-600 hover:text-purple-700'>
                查看全部
              </Link>
            </div>
                ...
                <div
                  ...
                  <div className='flex items-center space-x-3'>
                    <div
                      ...
                      {tx.type === 'income' ? <DollarSign className='w-4 h-4' /> : <ArrowRight className='w-4 h-4' />}
                    </div>
                    <div>
                  ...
                  <span className={`text-sm font-medium ${tx.type === 'income' ? 'text-green-600' : 'text-gray-900'}`}>
                    {tx.type === 'income' ? '+' : '-'} NT$
