          ...
          <nav className='hidden lg:flex items-center space-x-1'>
            {navItems.map((item) => (
              <Link
                ...
                {item.badge && (
                  <span className='px-1.5 py-0.5 text-xs bg-red-500 text-white rounded-full'>{item.badge}</span>
                )}
              </Link>
            ))}
          </nav>
            ...
            <div className='relative'>
              ...
              {userMenuOpen && (
                <div className='absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-200 py-2 z-50'>
                  ...
                  <Link to='/settings' className='flex items-center space-x-2 px-4 py-2 text-gray-700 hover:bg-gray-50'>
